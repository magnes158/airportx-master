...
public class DataGen {
    ...
    private static String[] names = { "Josephina", "Joanna", "Rome", "Sallie", "Biddy", "Sauvage", "Kaleigh", "Niles",
            "Wallis", "Rosaleen", "Bret", "Whitaker", "Malcom", "Zara", "Peyton", "Ann", "Jaylen", "Saylor", "Xzavier",
            "Kaleigh", "Ewart" };
    private static String[] countries = { "Kenya", "Barbados", "Rwanda", "Jersey", "France", "England", "Turkey", "USA",
            "Canada", "Findland", "Italy", "China", "Japan", "Senegal", "Brasil", "Mexico" };
    ...
    public static Flight randomFlight(ArrayList<Airport> airports, ArrayList<Flight> allFlights) {
        ...
        String planeId = "" + (char) (r.nextInt(26) + 'A') + (char) (r.nextInt(26) + 'A') + "-" + r.nextInt(9)
                + r.nextInt(9) + r.nextInt(9);
        String carrier = "" + (char) (r.nextInt(26) + 'A') + (char) (r.nextInt(26) + 'A')
                + (char) (r.nextInt(26) + 'A');

        // Get random airport for destination and source and make sure the are not the
        // same
    ...
    public static Person randomPassenger(ArrayList<Person> IDlist) {
        ...
        String ticketNo = "" + (char) (r.nextInt(26) + 'A') + (r.nextInt(899999) + 100000)
                + (char) (r.nextInt(26) + 'A');
