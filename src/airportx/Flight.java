...
public class Flight implements Comparable<Flight> {
    ...
    public Flight(int flightId, String planeId, String carrier, String dest, String source, String depart, String arriv,
            int gate, String status) {
        this.flightId = flightId;
    ...
    private ArrayList<Person> fillonBoard() {
        ...
        temp.add(DataGen.randomPlaneCrew(temp).setJob("carrier"));
